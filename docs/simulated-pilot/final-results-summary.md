...
The simulated HumanEnerDIA A/B pilot evidence supports the proposal KPI story.
...
The exported KPI cards are stored in [docs/KPIs](../KPIs).
...
- The benchmark must be described as a simulated pilot, not as a completed live Romanian factory deployment.
