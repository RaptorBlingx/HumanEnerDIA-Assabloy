...
- Let the user answer from the assistant response and any supporting panel context.
- Stop timer.
...
- Let the user answer from the response and supporting panel context.
- Stop timer.
...
- Let the user answer from the chatbot explanation.
- Stop timer.
...
- Let the user summarize the deviation and recommended action.
- Stop timer.
