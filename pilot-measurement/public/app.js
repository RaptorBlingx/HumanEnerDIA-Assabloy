(function () {
    ...
    const STORAGE_KEY = 'humanenerdia_assaabloy_kpi_card_generator_v1';
    ...
    const TASKS = [
        ...
        },
        {
            ...
            task: 'Verify imported ASSA ABLOY energy-reading and press-production row counts.',
            target: 25,
        ...
        },
        {
            ...
            task: 'Confirm the Bret transformer reference-meter boundary and that no per-press energy was invented.',
            target: 25,
            targetLabel: '25% technical intervention reduction'
        },
        {
        ...
        },
        {
            ...
            task: 'Generate or retrieve the monthly reporting result for the ASSA ABLOY partner press shop.',
            target: 25,
            targetLabel: '25% technical intervention reduction'
        }
    ];
    ...
    function finalOverlayText(final) {
        ...
        return [
            'Final ASSA ABLOY real-partner benchmark KPI summary.',
            ...
            final.allTargetsMet ? 'Conclusion: real-partner benchmark evidence meets the proposal KPI targets.' : 'Conclusion: one or more KPI targets still need complete measured values.'
        ].join('\n');
    }
    ...
    function drawFinalCard(final) {
        const ctx = canvasContext();
        drawBackground(ctx);
        drawHeader(ctx, 'Final KPI Evidence Summary', 'ASSA ABLOY Partner Press Shop', 'WASABI / HumanEnerDIA');
        drawMainTitle(ctx, 'Proposal KPI Results', 'A/B benchmark using the same personas, ASSA ABLOY tasks, and measured task-performance criteria.');
